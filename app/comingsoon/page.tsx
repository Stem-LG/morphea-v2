    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-white to-gray-50 flex flex-col items-center justify-center px-4 relative overflow-hidden">
            ...
            <div className="max-w-3xl mx-auto text-center relative z-10">
                ...
                {/* Main Content */}
                <div className="mb-8 md:mb-12 space-y-6 md:space-y-12">
                

                    {/* Main Message */}
                        <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-light text-gray-900 tracking-wide px-4">
                ...
                <div className="max-w-xl mx-auto px-4">
                    <p className="mb-6 md:mb-8 text-sm md:text-base text-gray-600 font-light leading-relaxed">
                    ...
                    <form onSubmit={onSubmit} className="relative group">
                        <input
                            ...
                            className="w-full h-12 md:h-14 px-4 md:px-6 pr-12 md:pr-14 rounded-full border-2 border-gray-200 text-sm md:text-base transition-all outline-none focus:border-gray-400 focus:ring-2 focus:ring-gray-100 disabled:cursor-not-allowed disabled:opacity-50 bg-white/80 backdrop-blur"
                        />
                        <button
                            type="submit"
                            disabled={isSubmitting}
                            className="absolute top-1/2 right-1.5 md:right-2 flex size-9 md:size-10 -translate-y-1/2 items-center justify-center rounded-full bg-gradient-to-b from-slate-900 via-sky-900 to-cyan-950 text-white transition-all hover:bg-gray-900 disabled:cursor-not-allowed disabled:opacity-50 group-hover:scale-105"
                        >
                            {isSubmitting ? (
