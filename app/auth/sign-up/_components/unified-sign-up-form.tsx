...
interface UnifiedSignUpFormProps extends React.ComponentPropsWithoutRef<"div"> {
...
export function UnifiedSignUpForm({ 
    ...
    const { t } = useLanguage();
    const { visitorData: existingVisitorData, isLoading: isLoadingVisitor } = useVisitorData();
    ...
    return (
        <div className={cn("flex flex-col gap-8 max-w-md mx-auto", className)} {...props}>
            {/* Header */}
