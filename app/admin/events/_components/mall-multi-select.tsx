                    ...
                    <Card className="border-0 bg-transparent">
                        <CardContent className="p-0">
                            <div className="flex items-center justify-between p-3 border-b border-gray-600">
                                <Label className="text-sm font-medium text-gray-300">{t('admin.events.malls.selectMalls')}</Label>
                            ...
                            <ScrollArea className="h-60">
                                <div className="p-2 space-y-2">
                                    {isLoading ? (
                                        <div className="text-center py-4 text-gray-400">{t('admin.events.malls.loadingMalls')}</div>
                                    ) : malls.length === 0 ? (
                                        <div className="text-center py-4 text-gray-400">{t('admin.events.malls.noMallsFound')}</div>
                                    ) : (
                                        malls.map((mall) => (
                                            <div
                                                key={mall.ymallid}
