    ...
    return (
        <div className="p-6 space-y-6">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                <div>
                    <h1 className="text-3xl lg:text-4xl font-bold text-white mb-2">{t('admin.events.title')}</h1>
                    <p className="text-lg text-gray-300">
                        {isAdmin ? t('admin.events.subtitle') : `${events?.length || 0} ${t('admin.events.subtitleCount')}`}
                    </p>
                </div>
                ...
                {isError && (
                    <Card className="bg-gradient-to-br from-red-900/20 to-red-800/10 border-red-700/50 backdrop-blur-sm">
                        <CardContent className="flex flex-col items-center justify-center py-12 text-center">
                            ...
                            <h3 className="text-xl font-semibold text-white mb-2">{t('admin.events.errorLoadingEvents')}</h3>
                        ...
                        {events.length > 0 ? (
                            ...
                            <Card className="bg-gradient-to-br from-gray-900/50 to-gray-800/30 border-gray-700/50 backdrop-blur-sm">
                                <CardContent className="flex flex-col items-center justify-center py-12 text-center">
                                    ...
                                    <h3 className="text-xl font-semibold text-white mb-2">{t('admin.events.noEventsFound')}</h3>
                                    <p className="text-gray-400 mb-6">
                                        {isAdmin
                                            ? t('admin.events.noEventsCreated')
                                            : t('admin.events.noEventsAvailable')}
                                    </p>
                                </CardContent>
                            </Card>
                        )}
