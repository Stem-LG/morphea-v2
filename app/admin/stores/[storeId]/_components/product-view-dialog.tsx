                            ...
                            <div className="p-6 space-y-6">
                                ...
                                <Card className="bg-gray-800/50 border-gray-700">
                                    ...
                                    <CardContent className="space-y-4">
                                        ...
                                        <div>
                                            <Label className="text-gray-300 text-sm">{t("admin.visibility") || "Visibility"}</Label>
                                            <div className="flex items-center gap-2 mt-1">
                                                {product.yestvisible ? (
                                                    <>
                                                        <Eye className="h-4 w-4 text-green-400" />
                                                        <span className="text-green-400 font-medium">{t("admin.visible") || "Visible"}</span>
                                                    </>
                                                ) : (
                                                    <>
                                                        <EyeOff className="h-4 w-4 text-gray-400" />
                                                        <span className="text-gray-400 font-medium">{t("admin.invisible") || "Hidden"}</span>
                                                    </>
                                                )}
                                            </div>
                                        </div>
    ...
    return (
        <Card className="bg-gray-800/50 border-gray-700">
            ...
            <CardContent className="space-y-3">
                {/* Visibility Status - always visible, but only editable for admin users */}
                <div className="flex items-center justify-between text-xs bg-gray-700/30 p-2 rounded">
                    ...
                    <div className="flex items-center gap-2">
                        <span className={`text-xs ${variant.yestvisible ? 'text-green-400' : 'text-gray-400'}`}>
                            {variant.yestvisible ? (t("admin.visible") || "Visible") : (t("admin.invisible") || "Hidden")}
                        </span>
                        {canEditVisibility && (
                            <Switch
