        ...
        <>
            <div className="p-6 space-y-6">
                ...
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                    <div>
                        <h1 className="text-3xl lg:text-4xl font-bold text-white mb-2">Designer Assignments</h1>
                        <p className="text-lg text-gray-300">Assign designers to boutiques for events</p>
                    </div>
                </div>
                    ...
                    <Card className="bg-gradient-to-br from-gray-900/50 to-gray-800/30 border-gray-700/50 backdrop-blur-sm">
                        ...
                        <CardContent>
                            <BoutiqueGrid
                                ...
                                assignments={eventMallBoutiques?.assignments || []}
                ...
                {(!selectedEventId || !selectedMallId) && (
                    <Card className="bg-gradient-to-br from-gray-900/50 to-gray-800/30 border-gray-700/50 backdrop-blur-sm">
                        <CardContent className="flex flex-col items-center justify-center py-12 text-center">
                            ...
                            <h3 className="text-xl font-semibold text-white mb-2">Select Event and Mall</h3>
